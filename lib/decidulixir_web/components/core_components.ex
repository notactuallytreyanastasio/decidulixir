defmodule DecidulixirWeb.CoreComponents do
  ...
  use Gettext, backend: DecidulixirWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DecidulixirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DecidulixirWeb.Gettext, "errors", msg, opts)
    end
  end
